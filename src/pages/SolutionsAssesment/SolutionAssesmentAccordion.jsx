...
import { solutionAssesmentAccordion } from "../../utils/data/AccordionData";

function SolutionAssesmentAccordion() {
  ...
  return (
    <Container>
      ...
      {solutionAssesmentAccordion.map((item, index) => (
        <FAQ key={index}>
...
export default SolutionAssesmentAccordion;
